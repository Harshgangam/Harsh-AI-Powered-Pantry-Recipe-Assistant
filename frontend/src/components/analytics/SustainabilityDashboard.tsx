...
export const SustainabilityDashboard: React.FC = () => {
  ...
  return (
    <div style={{ background: 'rgba(255, 255, 255, 0.05)', padding: '24px', borderRadius: '16px', border: '1px solid rgba(255, 255, 255, 0.1)', marginBottom: '24px' }}>
      <h2 style={{ margin: '0 0 4px', fontSize: '20px', fontWeight: 700, color: '#f3f4f6' }}>🌱 Sustainability & Pantry Analytics</h2>
      <p style={{ margin: '0 0 20px', color: '#9ca3af', fontSize: '13px' }}>Quantifiable impact metrics tracking your household pantry utilization journey.</p>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '16px', marginBottom: '24px' }}>
        <div style={{ background: 'rgba(0,0,0,0.3)', border: '1px solid rgba(255,255,255,0.08)', padding: '16px', borderRadius: '12px' }}>
          <div style={{ fontSize: '12px', color: '#9ca3af' }}>High-Risk Items Utilized</div>
      ...
      {/* 7-Day Trend Chart */}
      <div>
        <h3 style={{ fontSize: '14px', color: '#e2e8f0', marginBottom: '12px' }}>📊 7-Day Pantry Utilization Activity</h3>
